...
<section class="section-movieList-1 flex items-center justify-center min-h-screen">
  <div class="border-4 m-4 p-5 rounded-3xl w-full max-w-2xl bg-color-2 overflow-hidden">
    <div>
       <div class="my-4  sm:mx-10 text-center bg-white rounded-3xl py-4 text-base border bg-white rounded-3xl p-2 ">
     <i class="far fa-grin"></i><span> 영상 썸네일을 클릭해 보세요! </span><i class="far fa-grin"></i>     
     <div class="mt-1"><i class="far fa-play-circle mt-2"></i><i class="far fa-play-circle mt-2"></i><i class="far fa-play-circle mt-2"></i></div>
